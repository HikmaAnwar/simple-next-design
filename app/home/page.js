...
const Home = () => {
    ...
    return (
        <div className="flex justify-between item-center p-7 pt-14 pl-14 w-full bg-white">
            <div className="pr-4 font-monospace mt-20 pt-7 w-1/2 text-black">
            ...
            <div className="w-1/2 h-1 pt-24">
                <Image src="/assets/home.jpg" alt='female image' className='ml-20' width={500} height={500}/>
            </div>
        </div>
    );
};
